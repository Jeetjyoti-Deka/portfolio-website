...
const Project = ({ title, description, tags, imageUrl }: ProjectProps) => {
  ...
  return (
    ...
    >
      <section className=" bg-gray-100 max-w-[42rem] border border-black/5 overflow-hidden sm:pr-8 relative sm:h-[20rem] sm:group-even:pl-10 rounded-lg hover:bg-gray-200 transition dark:bg-white/10 dark:hover:bg-white/20 dark:text-white">
